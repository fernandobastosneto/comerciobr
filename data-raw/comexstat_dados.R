...
dic_ncm_fatores <- vroom::vroom(here::here("data-raw", "ncm.csv"),
...
>>>>>>> 3d367020ceb9a83e4b6b09d0ec751362ab42f7f3
}
...
<<<<<<< HEAD
fatores_files <- fs::dir_ls(here::here("temp", "filtrados"), regexp = "fatores.csv$")
=======
